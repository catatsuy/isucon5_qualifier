...
var commentCh chan Comment = make(chan Comment, 100)
var commentsForMeTable map[int][]Comment = make(map[int][]Comment)
var commentsForMeMutex sync.Mutex = sync.Mutex{}
...
func initCommentsForMe(userID int, num int) []Comment {
	commentsForMeMutex.Lock()
